...
**3\. Inyectamos el Dashboard JSON:** Los dashboards de Grafana son archivos JSON muy extensos. He preparado uno compacto que extrae las métricas exactas que tienes en tu InfluxDB (`sent_pps`, `asymmetry_index`, `error_rate`).
...
1. Abre tu navegador web en Windows y ve a: [**`http://localhost:3000`](http://localhost:3000) `O http://localhost:3000/login`**  
